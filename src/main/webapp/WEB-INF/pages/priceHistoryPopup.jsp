...
<jsp:useBean id="priceHistory" type="com.es.phoneshop.model.product.price.PriceHistory" scope="request"/>
<tags:popup pageTitle="Price history ${product.description}">
    ...
    <table style="width:100px;float:left">
        ...
        <c:forEach var="price" items="${priceHistory.prices}">
            <tr>
                <td><fmt:formatNumber value="${price}" type="currency" currencySymbol="${product.currency.symbol}"/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
